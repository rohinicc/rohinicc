...
<details>
<summary>&nbsp;<b>🧠 Real-Time Sign Language Interpreter</b>&nbsp;—&nbsp;<i>OpenCV + MediaPipe + CNN</i></summary>
<br/>

```
  Description  :  Real-time hand gesture recognition → Text + Voice
  Stack        :  OpenCV + MediaPipe + CNN (MobileNetV2)
  Recognizes   :  Hello | Bye | Good Morning | Good Evening
  Highlight    :  Works live via webcam with voice output
  Status       :  ✅ Working
```
...
<details>
<summary>&nbsp;<b>⚙️ DevOps CI/CD Pipeline</b>&nbsp;—&nbsp;<i>Jenkins + Docker + Kubernetes</i></summary>
<br/>
...
<details>
<summary>&nbsp;<b>☁️ Infrastructure Automation with Ansible</b>&nbsp;—&nbsp;<i>Ansible + SSH</i></summary>
<br/>

```yaml
  # Ansible Playbook Automation
  - Automated server configuration across multiple nodes
  - Managed remote access via SSH key authentication
  - Streamlined app deployments with reusable playbooks
  - Status: ✅ Running
```
